...
- [x] **Phase 4: README + Packaging** — Ship the README (open-key-signature gating leads), MIT LICENSE, and verify install on the user's actual macOS Dorico install (completed 2026-05-02)
...
| 4. README + Packaging | 3/3 | Complete   | 2026-05-02 |
